        ...
        <div class="buttons">
            ...
            <div class="options">
                ...
                <?php
                    if($type == 'radio'){
                ?>
                    <div class="custom_radio size_radio_custom">
                    <?php
                        $i=1;
                ...
                ?>
                    <label class="textarea">
                        <textarea class="optional form-control" rows="2" cols="200" name="<?php echo $name;?>"><?php echo $this->crud_model->is_added_to_cart($row['product_id'], 'option', $name); ?></textarea>
                    </label>
                <?php
